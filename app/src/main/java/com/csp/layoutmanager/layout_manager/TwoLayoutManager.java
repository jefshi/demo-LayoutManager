package com.csp.layoutmanager.layout_manager;
...
public class TwoLayoutManager extends RecyclerView.LayoutManager {
    ...
    /**
     * 用于获取RecyclerView在垂直方向上的可用空间，即去除了padding后的高度：
     */
